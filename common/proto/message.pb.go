...
func (m *RegisterHandler) Validate() error {
	return nil
}

func (m *RegisterHandler) Reset()         { *m = RegisterHandler{} }
func (m *RegisterHandler) String() string { return proto.CompactTextString(m) }
func (*RegisterHandler) ProtoMessage()    {}
func (*RegisterHandler) Descriptor() ([]byte, []int) {
	return fileDescriptor_33c57e4bae7b9afd, []int{2}
}

func (m *RegisterHandler) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RegisterHandler.Unmarshal(m, b)
}
func (m *RegisterHandler) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RegisterHandler.Marshal(b, m, deterministic)
}
func (m *RegisterHandler) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegisterHandler.Merge(m, src)
}
func (m *RegisterHandler) XXX_Size() int {
	return xxx_messageInfo_RegisterHandler.Size(m)
}
func (m *RegisterHandler) XXX_DiscardUnknown() {
	xxx_messageInfo_RegisterHandler.DiscardUnknown(m)
}

var xxx_messageInfo_RegisterHandler proto.InternalMessageInfo

func (m *RegisterHandler) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RegisterHandler)(nil), "proto.RegisterHandler")
}
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	0xc1, 0x13, 0x04, 0x66, 0x2b, 0x79, 0x70, 0x71, 0x44, 0x90, 0xa8, 0x47, 0x48, 0x84, 0x8b, 0x35,
	0x2f, 0xb5, 0x24, 0x33, 0x45, 0x82, 0x59, 0x81, 0x51, 0x83, 0x39, 0x08, 0xc2, 0x51, 0x52, 0xe5,
	0xe2, 0x0f, 0x4a, 0x4d, 0xcf, 0x2c, 0x2e, 0x49, 0x2d, 0xf2, 0x48, 0xcc, 0x4b, 0xc9, 0x49, 0x2d,
	0x02, 0x69, 0xce, 0x4b, 0xcc, 0x85, 0x1b, 0x08, 0x62, 0x27, 0xb1, 0x81, 0xdd, 0x6a, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0x94, 0xd6, 0x2a, 0xc4, 0xc3, 0x00, 0x00, 0x00,
}
